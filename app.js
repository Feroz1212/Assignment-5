...
function ass4task3(){
    ...
    document.write("<h1>Rules for naming JS variables</h1><br><br>Variable names can only contain numbers,$,and _ for Feroz :$ my_1stvariable <br/> Variables must begin with a letter $ or_For Feroz $my_1stVariable <br/> Variable names are case sensitive <br/> Variable names should not be JS keyword");
